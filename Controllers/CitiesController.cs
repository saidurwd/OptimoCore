...
namespace OptimoCore.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(devDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CountryId,StateId,CityName,City3Code,City2Code,Status")] City city)
        {
            if (id != city.Id)
            {
                return NotFound();
